...
/**
 * Nigel here,
 * OK here's the deal: Angular usually generates the ngsw-worker.js,
 * but we got some problems. Check out this issue
 * 
 * https://github.com/angular/angular/issues/20756
 * 
 * tl;dr: The Angular service worker breaks in Chromium-based browsers 59 and under.
 * At time of writing (Oct 15 2018) this apparently includes some peoples' versions
 * of the Samsung Internet browser for Android. It's super bad because the site
 * just doesn't load at all, and instead shows a network error.
 * 
 * SO this is just the regular ngsw-worker.js but with a polyfill at the top.
 */

/**
 * Here's the polyfill:
 * Taken from https://github.com/jakearchibald/async-waituntil-polyfill
 */
{
...
/**
 * The rest of this file is the same as Angular 6.0.5 generates. Bye!
 */
